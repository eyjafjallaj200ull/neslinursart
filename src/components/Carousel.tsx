    ...
    return (
        <div className='overflow-hidden' ref={emblaRef}>
            <div className='flex gap-3'>
                ...
                <Image className='max-h-[400px] sm:max-h-[600px] object-cover' priority={true} src={Neighbourhood} alt="A Neighbourhood" sizes="(min-width: 460px) 417px, calc(83.57vw + 49px)" />
